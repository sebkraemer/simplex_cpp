...
// configuration step. It creates a namespace called `simplex_cpp`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", simplex_cpp::cmake::project_name, simplex_cpp::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", simplex_cpp::cmake::project_version);
      return EXIT_SUCCESS;
    }
